...
export function LegacyPanel() {
  ...
  return (
    <>
      ...
      <div className="mt-2 flex items-end justify-between text-xs lg:mt-[8px] lg:text-[12px]"><span>Permanent production bonus</span><strong className="lg:text-[16px] lg:leading-[20px]">+{state.meta.totalLegacyEarned * LEGACY_PRODUCTION_BONUS * 100}%</strong></div>
